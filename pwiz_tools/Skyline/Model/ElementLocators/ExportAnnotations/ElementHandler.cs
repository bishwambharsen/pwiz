...
namespace pwiz.Skyline.Model.ElementLocators.ExportAnnotations
{
    public static class ElementHandlers
    {
        ...
        {
            private IDictionary<string, PropertyDescriptor> _importableProperties;
            ...
            public ElementHandler(SkylineDataSchema dataSchema)
            {
                ...
                _importableProperties = ListImportableProperties().ToDictionary(pd => pd.Name);
            ...
            public IEnumerable<PropertyDescriptor> Properties { get { return _importableProperties.Values; } }
